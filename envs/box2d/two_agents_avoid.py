...
class Avoiding_v0:
    """agent 2 avoids agent 1, discrete action"""
...
class Avoiding_v1(Avoiding_v0):
    ...
    def __init__(self, PPM=20.0, 
                       ...
                       random_pos=False,
                       restitution=0):
        super(Avoiding_v1, self).__init__(PPM, TARGET_FPS, SCREEN_WIDTH, SCREEN_HEIGHT, TIME_STEP, enable_renderer, random_pos, restitution)
        if self.enable_renderer:
            pygame.display.set_caption('Avoiding_v1')
